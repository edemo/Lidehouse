...
//    { data: 'localizer', title: __('schemaParcelBillings.localizer.label'), render: l => displayLocalizer(l, communityId) },
    ...
    { data: 'consumption.unitPrice', title: __('schemaParcelBillings.consumption.unitPrice.label') },
    { data: 'consumption.uom', title: __('schemaParcelBillings.consumption.uom.label') },
