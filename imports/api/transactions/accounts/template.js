...
//    { code: '`389', name: 'Barter account', category: 'technical' }, // Barter számla
    ...
    { code: '`5510', name: 'Hő- és füstelvezető rendszer', category: 'expense' },
    { code: '`55101', name: 'Hő- és füstelvezető rendszer karbantartás', category: 'expense' },
    { code: '`55102', name: 'Hő- és füstelvezető rendszer javítás', category: 'expense' },
    { code: '`5511', name: 'Tűzjelző rendszer', category: 'expense' },
    { code: '`55111', name: 'Tűzjelző rendszer karbantartás', category: 'expense' },
    { code: '`55112', name: 'Tűzjelző rendszer javítás', category: 'expense' },
    { code: '`5512', name: 'CO rendszer', category: 'expense' },
    { code: '`55121', name: 'CO rendszer karbantartás', category: 'expense' },
    { code: '`55122', name: 'CO rendszer javítás', category: 'expense' },
    { code: '`5513', name: 'Tűzoltó készülékek és fali tűzcsapok', category: 'expense' },
    { code: '`55131', name: 'Tűzoltó készülékek és fali tűzcsapok karbantartása', category: 'expense' },
    { code: '`55132', name: 'Tűzoltó készülékek javítása, cseréje', category: 'expense' },
    { code: '`5514', name: 'Tüzivíz nyomásfokozó szivattyú', category: 'expense' },
    { code: '`55141', name: 'Tüzivíz nyomásfokozó szivattyú karbantartás', category: 'expense' },
    { code: '`55142', name: 'Tüzivíz nyomásfokozó szivattyú javítás', category: 'expense' },
    { code: '`5515', name: 'Tűzgátló ajtók', category: 'expense' },
    { code: '`55151', name: 'Tűzgátló ajtók karbantartása', category: 'expense' },
    { code: '`55152', name: 'Tűzgátló ajtók javítása', category: 'expense' },
    { code: '`5516', name: 'Tűzgátló lezárások, tűz- és füstcsappantyúk', category: 'expense' },
    { code: '`55161', name: 'Tűzgátló lezárások, tűz- és füstcsappantyúk karbantartás', category: 'expense' },
    { code: '`55162', name: 'Tűzgátló lezárások, tűz- és füstcsappantyúk javítás', category: 'expense' },
    { code: '`5517', name: 'Irányfények, biztonsági világítás', category: 'expense' },
    { code: '`55171', name: 'Irányfények, biztonsági világítás karbantartás', category: 'expense' },
    { code: '`55172', name: 'Irányfények, biztonsági világítás javítás, csere', category: 'expense' },
    { code: '`5518', name: 'Tűzvédelmi ellenőrzések', category: 'expense' },
    { code: '`55181', name: 'Tűzvédelmi megbízotti feladatok', category: 'expense' },
    { code: '`5519', name: 'Tűzjelző átjelzés', category: 'expense' },
    { code: '`55190', name: 'Tűzriasztás átjelzés', category: 'expense' },
    { code: '`55191', name: 'Tűzriasztás átjelzés karbantartás', category: 'expense' },
    { code: '`55192', name: 'Tűzriasztás átjelzés javítás', category: 'expense' },
    { code: '`55193', name: 'Tűzoltósági kivonulás', category: 'expense' },
    ...
    { code: '`5531', name: 'Kazán', category: 'expense' },
    { code: '`55311', name: 'Kazán karbantartás', category: 'expense' },
    { code: '`55312', name: 'Kazán javítás', category: 'expense' },
    ...
    { code: '`55341', name: 'Villanyszerelési karbantartás', category: 'expense' },
    { code: '`55342', name: 'Villanyszerelési javítás', category: 'expense' },
    { code: '`5535', name: 'Szellőző rendszer', category: 'expense' },
    { code: '`55351', name: 'Szellőző rendszer karbantartás', category: 'expense' },
    { code: '`55352', name: 'Szellőző rendszer javítás', category: 'expense' },
    { code: '`5536', name: 'Garázskapu és beléptető rendszer', category: 'expense' },
    { code: '`55361', name: 'Garázskapu és beléptető rendszer karbantartás', category: 'expense' },
    { code: '`55362', name: 'Garázskapu és beléptető rendszer javítás', category: 'expense' },
    { code: '`5537', name: 'Esővíz szivattyú, purátor', category: 'expense' },
    { code: '`55371', name: 'Esővíz szivattyú, purátor karbantartás', category: 'expense' },
    { code: '`55372', name: 'Esővíz szivattyú, purátor javítás', category: 'expense' },
    { code: '`5538', name: 'Kaputelefon', category: 'expense' },
    { code: '`55381', name: 'Kaputelefon karbantartás', category: 'expense' },
    { code: '`55382', name: 'Kaputelefon javítás', category: 'expense' },
    { code: '`5539', name: 'Egyéb gépészet', category: 'expense' },
    { code: '`55391', name: 'Egyéb gépészeti karbantartás', category: 'expense' },
    { code: '`55392', name: 'Egyéb gépészeti javítások', category: 'expense' },
    ...
    { code: '`555', name: 'Kémény', category: 'expense' },
    { code: '`5551', name: 'Kémény karbantartás, tisztítás', category: 'expense' },
