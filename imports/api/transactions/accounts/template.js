...
//    { code: '`389', name: 'Barter account', category: 'technical' }, // Barter számla
    ...
    { code: '`52759', name: 'Egyéb kommunikációs költség', category: 'expense' },
    { code: '`529', name: 'Egyéb megbízási-, vállalkozási díjak', category: 'expense' },
    { code: '`53', name: 'Egyéb szogáltatási költségek', category: 'expense' },
    ...
    { code: '`5523', name: 'Lift költségek', category: 'expense' },
    ...
    { code: '`5524', name: 'Kamerarendszer karbantartás', category: 'expense' },
