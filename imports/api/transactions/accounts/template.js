...
*/
/*
  Templates.define({ _id: 'Condominium_Localizer', accounts: [
    { code: '`', name: 'Locations', category: 'location', locked: true },
    { code: '`@', name: 'Parcels', locked: true }, // Albetétek
//    { code: '`@A', name: 'Main building' },

    { code: '`&', name: 'Common areas', locked: true },  // Közös tulajdonú helyiségek
    { code: '`&1', name: 'Padlás' },
    { code: '`&2', name: 'Pince' },
    { code: '`&3', name: 'Kert' },
    { code: '`&4', name: 'Tárolók' },
    { code: '`&5', name: 'Garázs' },
    { code: '`&6', name: 'Lépcsőház' },
    { code: '`&7', name: 'Folyosók' },
    { code: '`&9', name: 'Egyeb helyiségek' },

    { code: '`#', name: 'Places', locked: true }, // Elszámolási egységek
    { code: '`#1', name: 'Central' },   // Központ
    { code: '`#2', name: 'Tartószerkezetek' },
    { code: '`#21', name: 'Falak' },
    { code: '`#22', name: 'Födémek' },
    { code: '`#23', name: 'Tető' },
    { code: '`#3', name: 'Szakipari szerkezetek' },
    { code: '`#31', name: 'Homlokzat' },
    { code: '`#32', name: 'Burkolat' },
    { code: '`#4', name: 'Gépészeti szerkezetek' },
    { code: '`#41', name: 'Ventillation' }, // Szellőző rendszer
    { code: '`#43', name: 'Heating system' }, // Kazán
    { code: '`#44', name: 'Klima' },
    { code: '`#45', name: 'Villamos hálózat' },
    { code: '`#46', name: 'Felügyeleti rendszer' },
    { code: '`#47', name: 'Lift' },
    { code: '`#48', name: 'Kamera rendszer' },
  ],
  });*/
}
