...
//  { name: 'delegations.remove',     roles: nobody, allowAuthor: true },
  ...
  { name: 'transactions.insert',        roles: ['accountant', 'treasurer'] },
  { name: 'transactions.update',        roles: ['accountant', 'treasurer'] },
  { name: 'transactions.remove',        roles: ['accountant', 'treasurer'] },
  { name: 'transactions.listing',       roles: ['accountant', 'treasurer', 'overseer'] },
