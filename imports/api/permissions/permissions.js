...
//  { name: 'delegations.remove',     roles: nobody, allowAuthor: true },
  ...
  { name: 'vote.statusChangeTo.closed.leave',         roles: ['manager'] },
  { name: 'vote.statusChangeTo.deleted.enter',        roles: ['manager'] },
  { name: 'vote.statusChangeTo.deleted.leave',        roles: ['manager'] },
  ...
  { name: 'forum.statusChangeTo.closed.leave',        roles: ['manager'] },
  { name: 'forum.statusChangeTo.deleted.enter',       roles: ['manager'] },
  { name: 'forum.statusChangeTo.deleted.leave',       roles: ['manager'] },
  ...
  { name: 'news.statusChangeTo.closed.leave',         roles: ['manager'] },
  { name: 'news.statusChangeTo.deleted.enter',        roles: ['manager'] },
  { name: 'news.statusChangeTo.deleted.leave',        roles: ['manager'] },
];
