...
//  { name: 'communities.insert',     roles: everyRole },
  ...
  { name: 'memberships.insert.batch', roles: ['manager'] },
  { name: 'memberships.update.batch', roles: ['manager'] },
  ...
  { name: 'parcels.insert.batch',   roles: ['manager'] },
  { name: 'parcels.update.batch',   roles: ['manager'] },
  ...
  { name: 'topics.insert.batch',    roles: ['manager'] },
  { name: 'topics.update.batch',    roles: ['manager'] },
...
//  { name: 'delegations.remove',     roles: nobody, allowAuthor: true },
  ...
  { name: 'balances.insert.batch',  roles: ['manager', 'accountant'] },
  ...
  { name: 'transactions.insert.batch', roles: ['manager', 'accountant', 'treasurer'] },
  { name: 'transactions.update.batch', roles: ['manager', 'accountant', 'treasurer'] },
