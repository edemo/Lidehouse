...
//  { name: 'delegations.remove',     roles: nobody, allowAuthor: true },
  ...
  { name: 'bankstatements.inCommunity',roles: ['manager', 'accountant', 'treasurer', 'overseer'] },
  { name: 'bankstatements.insert',  roles: ['manager', 'accountant', 'treasurer'] },
  { name: 'bankstatements.update',  roles: ['manager', 'accountant'] },
  { name: 'bankstatements.remove',  roles: ['manager', 'accountant'] },
