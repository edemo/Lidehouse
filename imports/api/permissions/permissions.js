...
//  { name: 'communities.insert',     roles: everyRole },
  ...
  { name: 'maintenance.insert',     roles: ['manager'] },
  { name: 'maintenance.update',     roles: ['manager'] },
  { name: 'maintenance.remove',     roles: ['manager'] },
...
//  { name: 'delegations.remove',     roles: nobody, allowAuthor: true },
  ...
  { name: 'feedback.statusChangeTo.closed.enter',     roles: ['manager'] },
