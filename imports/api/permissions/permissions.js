...
//  { name: 'delegations.remove',     roles: nobody, allowAuthor: true },
  ...
  { name: 'task.insert',            roles: ['manager', 'maintainer'], allowAuthor: true },
  { name: 'task.update',            roles: ['manager', 'maintainer'], allowAuthor: true },
  { name: 'task.remove',            roles: ['manager'], allowAuthor: true },
  ...
  { name: 'ticket.statusChangeTo.reported.insert',     roles: exceptGuest },
  { name: 'ticket.statusChangeTo.confirmed.insert',    roles: ['manager', 'maintainer'] },
  { name: 'ticket.statusChangeTo.toApprove.insert',    roles: ['manager', 'maintainer'] },
  { name: 'ticket.statusChangeTo.toVote.insert',       roles: ['manager', 'maintainer'] },
  { name: 'ticket.statusChangeTo.scheduled.insert',    roles: ['manager', 'maintainer'] },
  { name: 'ticket.statusChangeTo.progressing.insert',  roles: ['manager', 'maintainer'] },
  { name: 'ticket.statusChangeTo.suspended.insert',    roles: ['manager', 'maintainer'] },
  { name: 'ticket.statusChangeTo.finished.insert',     roles: ['manager', 'maintainer'] },
  { name: 'ticket.statusChangeTo.closed.insert',       roles: ['manager', 'maintainer'] },
  { name: 'ticket.statusChangeTo.deleted.insert',      roles: ['manager', 'maintainer'] },
  { name: 'vote.statusChangeTo.open.insert',           roles: ['manager', 'maintainer'] },
  { name: 'vote.statusChangeTo.closed.insert',         roles: ['manager', 'maintainer'] },
];
