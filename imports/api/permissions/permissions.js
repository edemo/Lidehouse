...
//  { name: 'delegations.remove',     roles: nobody, allowAuthor: true },
  ...
  { name: 'statusChangeTo.toApprove.insert',    roles: ['manager', 'maintainer'] },
  { name: 'statusChangeTo.toVote.insert',       roles: ['manager', 'maintainer'] },
  { name: 'statusChangeTo.scheduled.insert',    roles: ['manager', 'maintainer'] },
