...
export const Permissions = [
  ...
  { name: 'parcels.finances',       roles: ['manager', 'accountant', 'treasurer', 'overseer', 'owner'] },
  ...
  { name: 'meters.registerReading', roles: ['owner@parcel'] },
  ...
  { name: 'transactions.resend',    roles: ['admin'] }, // if the bill email needs to be resent
