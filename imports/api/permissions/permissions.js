...
//  { name: 'meters.inCommunity',     roles: ['manager'] },
  ...
  { name: 'moneyAccounts.inCommunity', roles: ['manager', 'accountant', 'treasurer', 'overseer'] },
  { name: 'moneyAccounts.insert',  roles: ['manager', 'accountant'] },
  { name: 'moneyAccounts.update',  roles: ['manager', 'accountant'] },
  { name: 'moneyAccounts.remove',  roles: ['manager', 'accountant'] },
