...
//  { name: 'communities.insert',     roles: everyRole },
  ...
  { name: 'meters.reading', roles: ['manager', 'accountant', 'treasurer', 'owner'] },
...
//  { name: 'delegations.remove',     roles: nobody, allowAuthor: true },
  ...
  { name: 'partners.conteer',       roles: ['manager', 'accountant', 'treasurer'] },
  ...
  { name: 'payments.conteer',       roles: ['manager', 'accountant', 'treasurer'] },
