...
import { displayLocalizer, displayTicketType, displayTicketStatus } from '/imports/ui_3/helpers/api-display.js';
...
export function ticketColumns(permissions) {
  ...
  return [
    ...
    { data: 'status', title: __('schemaTopics.status.label'), render: displayTicketStatus },
