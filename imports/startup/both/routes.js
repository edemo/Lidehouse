...
<<<<<<< HEAD
  import '/imports/ui_3/views/pages/work-planner.js';
=======
...
<<<<<<< HEAD
FlowRouter.route('/work-planner', {
  name: 'WorkPlanner',
  action() {
    BlazeLayout.render('Main_layout', { content: 'Work_planner' });
  },
});
CommunityRelatedRoutes.push('WorkPlanner');
=======
